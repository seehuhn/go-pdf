...
func (f *CompositeGlyf) FontInfo() any {
	dict, _ := f.makeDict()
	if dict == nil {
		return nil
	}
...
func (f *CompositeGlyf) Embed(e *pdf.EmbedHelper) (pdf.Native, error) {
...
func (f *CompositeGlyf) Layout(seq *font.GlyphSeq, ptSize float64, s string) *font.GlyphSeq {
	if seq == nil {
		seq = &font.GlyphSeq{}
	}
...
var _ font.Outliner = (*CompositeGlyf)(nil)

// GlyphID returns the glyph a CID selects.
// See [font.Outliner.GlyphID].
func (f *CompositeGlyf) GlyphID(c cid.CID) (glyph.ID, bool) {
...
func (f *CompositeGlyf) Outline(gid glyph.ID) path.Path {
