...
func (f *CompositeGlyf) Embed(e *pdf.EmbedHelper) (pdf.Native, pdf.Unused, error) {
...
func (f *CompositeGlyf) Encode(gid glyph.ID, width float64, text string) (charcode.Code, bool) {
