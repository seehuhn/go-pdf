...
func handleShading(s *State, args []pdf.Native, res interface{}) error {
...
func handleXObject(s *State, args []pdf.Native, res interface{}) error {
	p := argParser{args: args}
	name := p.GetName()
	if err := p.Check(); err != nil {
		return err
...
func handleMarkedContentPoint(s *State, args []pdf.Native, res interface{}) error {
	p := argParser{args: args}
	_ = p.GetName() // tag
	if err := p.Check(); err != nil {
		return err
...
func handleMarkedContentPointWithProperties(s *State, args []pdf.Native, res interface{}) error {
	p := argParser{args: args}
	_ = p.GetName() // tag
...
func handleBeginMarkedContent(s *State, args []pdf.Native, res interface{}) error {
	p := argParser{args: args}
	_ = p.GetName() // tag
	if err := p.Check(); err != nil {
		return err
...
func handleBeginMarkedContentWithProperties(s *State, args []pdf.Native, res interface{}) error {
	p := argParser{args: args}
	_ = p.GetName() // tag
	// Second arg can be name or dict
	if len(p.args) > 0 {
...
func handleEndMarkedContent(s *State, args []pdf.Native, res interface{}) error {
	p := argParser{args: args}
	if err := p.Check(); err != nil {
		return err
	}
...
func handleType3d0(s *State, args []pdf.Native, res interface{}) error {
	p := argParser{args: args}
	_ = p.GetFloat() // wx
	_ = p.GetFloat() // wy
	if err := p.Check(); err != nil {
...
func handleType3d1(s *State, args []pdf.Native, res interface{}) error {
	p := argParser{args: args}
	_ = p.GetFloat() // wx
	_ = p.GetFloat() // wy
	_ = p.GetFloat() // llx
...
func handleBeginCompatibility(s *State, args []pdf.Native, res interface{}) error {
	p := argParser{args: args}
	if err := p.Check(); err != nil {
		return err
	}
...
func handleEndCompatibility(s *State, args []pdf.Native, res interface{}) error {
	p := argParser{args: args}
	if err := p.Check(); err != nil {
		return err
	}
...
func handleRawContent(s *State, args []pdf.Native, res interface{}) error {
	p := argParser{args: args}
...
func handleInlineImage(s *State, args []pdf.Native, res interface{}) error {
	p := argParser{args: args}
