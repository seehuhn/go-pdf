...
func Extract(x *pdf.Extractor, obj pdf.Object, isDirect bool) (graphics.Shading, error) {
	...
	switch stNum {
	case 1:
		return extractType1(x, dict, isDirect)
	case 2:
		return extractType2(x, dict, isDirect)
	case 3:
		return extractType3(x, dict, isDirect)
	case 4:
