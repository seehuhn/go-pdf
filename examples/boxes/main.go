...
func doit() error {
	...
	page.TextShow(nil, "This text is outside the CropBox.  It will not be visible on most PDF viewers.")
	page.TextEnd()

	page.TextStart()
	page.TextFirstLine(60, 480)
	page.TextShow(nil, "Every PDF page has a MediaBox.  The MediaBox contains all other page boxes.")
	page.TextSecondLine(0, -12*geom.BaseLineDistance)
	page.TextShow(nil, "On this page, the MediaBox is the rectangle [0,600]×[0,600].")
	page.TextEnd()

	page.TextStart()
	page.TextFirstLine(60, 430)
	page.TextShow(nil, "PDF viewers restrict display of a page to the CropBox.")
	page.TextSecondLine(0, -12*geom.BaseLineDistance)
	page.TextShow(nil, "On this page, the CropBox is the rectangle [50,550]×[50,550].")
	page.TextEnd()

	page.TextStart()
	page.TextFirstLine(60, 336)
	page.TextShow(nil, "In professional production, the TrimBox gives the outline of the finished page after trimming.")
	page.TextSecondLine(0, -12*geom.BaseLineDistance)
	page.TextShow(nil, "On this page, the TrimBox is [100,500]×[100,500].  If your viewer supports BoxColorInfo,")
	page.TextNextLine()
	page.TextShow(nil, "the TrimBox may be shown in ")
	page.SetFillColor(color.DeviceRGB.New(0.8, 0.4, 0))
	page.TextShow(nil, "orange.")
	page.SetFillColor(color.DeviceGray.New(0))
	page.TextEnd()

	page.TextStart()
	page.TextFirstLine(60, 286)
	page.TextShow(nil, "In professional production, the BleedBox gives the print area before trimming.")
	page.TextSecondLine(0, -12*geom.BaseLineDistance)
	page.TextShow(nil, "On this page, the BleedBox is [85,515]×[85,515].  If your viewer supports BoxColorInfo,")
	page.TextNextLine()
	page.TextShow(nil, "the BleedBox may be shown in ")
	page.SetFillColor(color.DeviceRGB.New(0, 0, 0.8))
	page.TextShow(nil, "blue.")
	page.SetFillColor(color.DeviceGray.New(0))
	page.TextEnd()

	page.TextStart()
	page.TextFirstLine(60, 186)
	page.TextShow(nil, "The final page box is the ArtBox.")
	page.TextSecondLine(0, -12*geom.BaseLineDistance)
	page.TextShow(nil, "On this page, the ArtBox is [150,450]×[150,450].  If your viewer supports BoxColorInfo,")
	page.TextNextLine()
	page.TextShow(nil, "the ArtBox may be shown in ")
	page.SetFillColor(color.DeviceRGB.New(0, 0.8, 0))
	page.TextShow(nil, "green.")
	page.TextEnd()
