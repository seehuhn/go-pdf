...
func doit() error {
	...
	page.SetStrokeColor(graphics.DeviceGrayNew(0.85))
	...
	page.Stroke()
	page.SetFillColor(graphics.DeviceGrayNew(1))
	...
	page.Fill()
	page.SetFillColor(graphics.DeviceGrayNew(0.6))
	...
	page.SetFillColor(graphics.DeviceRGBNew(0.8, 0.4, 0))
	...
	page.SetFillColor(graphics.DeviceRGBNew(0, 0, 0.8))
	page.TextShow("blue.")
	page.SetFillColor(graphics.DeviceGrayNew(0))
	page.TextEnd()
	...
	page.SetFillColor(graphics.DeviceRGBNew(0, 0.8, 0))
	page.TextShow("green.")
	page.TextEnd()
