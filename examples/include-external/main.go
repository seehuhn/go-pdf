...
func run() error {
	...
	page.TextShow(nil, "Figure 1.  ")
	page.TextSetFont(F, 10)
	page.TextShow(nil, "A grid of pair scatter plots for R's built-in iris dataset.  The plot illustrates the joint distribution")
	page.TextSecondLine(0, -12)
	page.TextShow(nil, "of sepal length, sepal width, petal length, and petal width for three species of iris.")
	page.TextEnd()
