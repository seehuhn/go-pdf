...
func DecodeTarget(c pdf.Cursor, obj pdf.Object, _ bool) (Target, error) {
	if obj == nil {
		return nil, nil
	}
	...
	relationship, err := c.Name(dict["R"])
	if err != nil {
		return nil, err
	}
	...
	var next Target
	if dict["T"] != nil {
		next, err = pdf.Decode(c, dict["T"], DecodeTarget)
		if err != nil {
			return nil, err
		}
	}
	...
	case "C":
		...
		if name, _ := c.String(dict["N"]); name != nil {
