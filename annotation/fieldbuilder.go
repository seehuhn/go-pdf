...
func (c *FieldCommon) must() Field {
	if c.self == nil {
		panic("annotation: field builder used on a field not created by a builder")
	}
	return c.self
}
...
// AddWidget adds a widget annotation for this terminal field at the given
...
func (c *FieldCommon) AddWidget(rect pdf.Rectangle) *Widget {
	w := &Widget{
