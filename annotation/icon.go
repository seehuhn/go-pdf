...
// Icon represents the name of an icon used to represent a text annotation.
...
const (
	...
	IconNote         Icon = "Note"
	IconHelp         Icon = "Help"
	IconNewParagraph Icon = "NewParagraph"
	IconParagraph    Icon = "Paragraph"
	IconInsert       Icon = "Insert"
)
